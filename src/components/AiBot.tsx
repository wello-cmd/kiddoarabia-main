  ...
  return (
    <>
      ...
      <Button
        ...
        size="lg"
        aria-label={language === 'ar' ? 'افتح مساعد كيدو الذكي' : 'Open Kiddo AI Assistant'}
      >
        ...
        <Card className="fixed bottom-24 right-6 w-80 h-96 shadow-xl z-50">
          <CardHeader className="flex flex-row items-center justify-between pb-3">
            ...
            <Button
              ...
              aria-label={language === 'ar' ? 'إغلاق مساعد كيدو الذكي' : 'Close Kiddo AI Assistant'}
            >
              <X className="h-4 w-4" />
            </Button>
          </CardHeader>
            ...
            <div className="flex gap-2">
              {!apiKey && (
                <Button 
                  ...
                  className="text-xs"
                  aria-label={language === 'ar' ? 'إعداد مفتاح API' : 'Setup API Key'}
                >
                  API
                </Button>
              )}
