      ...
      <div className="bg-card/60 backdrop-blur-sm rounded-3xl p-8 lg:p-12 shadow-card mb-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="bg-emerald-600 rounded-3xl p-8 text-white text-center shadow-glow">
        ...
        <div className="bg-gradient-hero rounded-3xl p-8 text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            ...
            <Button
              ...
              onClick={() => toast.success('Thank you for subscribing! We\'ll keep you updated with our latest products and recipes.')}
            >
